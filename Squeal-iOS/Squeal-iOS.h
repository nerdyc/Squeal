...
//  Squeal-iOS
//
//  Created by Christian Niles on 4/8/17.
//
//
...
// In this header, you should import all the public headers of your framework using statements like #import <Squeal_iOS/PublicHeader.h>
